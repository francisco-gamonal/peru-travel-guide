...
El alcance de `population-comparison` MUST NOT incluir bloques de clima, cultura ni mejores épocas en la misma entrega.

#### Scenario: Home acotada a población

- **WHEN** el usuario usa la comparación poblacional
- **THEN** no se presentan secciones de clima, cultura o calendario de épocas como si estuvieran implementadas
