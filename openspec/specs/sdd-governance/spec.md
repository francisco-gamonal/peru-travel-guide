...
Define las convenciones del proceso spec-driven development aplicadas a este repositorio: trazabilidad spec → test, versionado semántico de capabilities, review gate antes de apply, breaking changes, changelog automático y presupuesto de performance. Complementa `specs/sdd-conventions.md` (referencia humana y contexto del agente).
